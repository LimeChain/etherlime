...
const specificFile = 'test/etherlime/cli-commands/deploy/deploymentScripts.js';
...
describe('Deploy cli command', () => {
    ...
    it('should deploy with compile parameter', async function () {
        ...
        fs.copyFileSync('./test/etherlime/cli-commands/deploy/examples/LimeFactory.sol', './contracts/LimeFactory.sol');
        fs.copyFileSync('./test/etherlime/cli-commands/deploy/examples/LimeFactoryLib.sol', './contracts/LimeFactoryLib.sol');
