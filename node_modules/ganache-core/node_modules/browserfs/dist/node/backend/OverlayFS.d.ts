...
export declare class UnlockedOverlayFS extends BaseFileSystem implements FileSystem {
     ...
     */
    initialize(cb: BFSOneArgCallback): void;
    isReadOnly(): boolean;
...
export default class OverlayFS extends LockedFS<UnlockedOverlayFS> {
     ...
     */
    constructor(writable: FileSystem, readable: FileSystem, deprecateMsg?: boolean);
    /**
     * **Deprecated. Please use OverlayFS.Create() to construct and initialize OverlayFS instances.**
     */
    initialize(cb: BFSOneArgCallback, deprecateMsg?: boolean): void;
    getOverlayedFileSystems(): {
        readable: FileSystem;
        writable: FileSystem;
    };
