...
exports.fsWrapper = {
    ...
    statAsync: utils_1.promisify(fs.stat),
    appendFileAsync: utils_1.promisify(fs.appendFile),
    accessAsync: utils_1.promisify(fs.access),
    doesFileExistAsync: function (filePath) { return __awaiter(_this, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, exports.fsWrapper.accessAsync(filePath, 
